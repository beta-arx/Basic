# Basic Collection
### Роботы для базового и эффективного управления группой в Telegram

Подборка ботов для активности, порядка и развлечения в группах.  
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="spam.png" style="width: 150px; height: 150px; display: block;">
    </td>
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="oracle.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="face.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="info.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="clock.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="adm.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="translator.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="ia.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="user.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="сhess.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="link.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
<table style="width: 100%; border-collapse: collapse; margin-bottom: 20px;">
  <tr>
    <td style="vertical-align: top; width: 0; padding: 0;">
      <img src="QRCode.png" style="width: 150px; height: 150px; display: block;">
    </td>
    <td style="vertical-align: top; padding-left: 15px;">
...
Каждый бот выполняет свою роль: от публикации мемов и генерации контента до мониторинга участников и автоматизации процессов.  
Коллекция подходит для любых групп, которым нужен порядок, активность и интерактив.
